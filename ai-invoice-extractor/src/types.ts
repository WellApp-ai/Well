...
import { ANTHROPIC_MODEL_ID, GOOGLE_MODEL_ID, MISTRAL_MODEL_ID, OPENAI_MODEL_ID, PROMPT_ID } from "./constants.js"
...
export const OllamaVendor = z.literal("ollama")

export type AiVendor = z.infer<typeof AiVendor>
export const AiVendor = z.union([MistralVendor, OpenAiVendor, GoogleVendor, AnthropicVendor, OllamaVendor])
